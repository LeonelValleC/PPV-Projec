<%@ Page Title="Approval PPVs" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ppv_detail.aspx.cs" Inherits="PPV_Projec.ppv_detail" %>
        ...
        <form id="form1" method="post" autocomplete="off">
            <div class="row">
                ...
                <div class="input-group input-group-icon">
                    ...
                    <input runat="server" type="text" placeholder="pn" id="txt_pn" name="txt_pn" />
                ...
                <div class="input-group input-group-icon">
                    <asp:Label Text="Buyer / PM:" runat="server" />
                    <input runat="server" type="text" placeholder="Buyer/PM" id="txt_Buyer" name="txt_Buyer" />
                ...
                <div class="col-half">
                    <div class="input-group">
                        <div class="col-third">
                            ...
                            <asp:RadioButtonList ID="Rb_times" name="Rb_times" runat="server" RepeatDirection="Horizontal" CellSpacing="30" CellPadding="30">
                        ...
                        <div class="col-third">
                            ...
                            <asp:CheckBoxList ID="cbl_changed" name="cbl_changed" runat="server" CellSpacing="30" CellPadding="30" RepeatDirection="Horizontal">
            ...
            <div class="row">
                ...
                <div class="col-third">
                    ...
                    <input runat="server" type="text" placeholder="Purchased Quantity" id="txt_qty" name="txt_NewPrice" />
                    <div class="input-icon"><i class="fa fa-user"></i></div>
                    <br />
                </div>
                <div class="input-group input-group-icon">
            ...
            <div class="row">
                <div class="input-group input-group-icon">
                    <asp:Button ID="btn_Submit" runat="server" Text="Approve" class="btn btn-lg btn-success " OnClick="btn_Submit_Click" />
                    <asp:Button ID="btn_Cancel" runat="server" Text="Decline" class="btn btn-lg btn-danger btn-style " OnClick="btn_Cancel_Click" />
