<%@ Page Title="Buyer PPV" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PPV_Detail_Buyer.aspx.cs" Inherits="PPV_Projec.PPV_Detail_Buyer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container1">
        <form id="form1" method="post" autocomplete="off">
            ...
            <div class="row">
                <div class="input-group input-group-icon">
                    <asp:Button ID="btn_Submit" runat="server" Text="Submit" class="btn btn-lg btn-success " OnClick="btn_Submit_Click" OnClientClick="return confirmation();"  />
