...
{
    public partial class PPV_Detail_Buyer : System.Web.UI.Page
    {
        PPVs ppv = new PPVs();
        //User user = new User();
        PartN pn = new PartN();
        ...
        protected void btn_Submit_Click(object sender, EventArgs e)
        {
            ...
            if (rb_salesOrder.SelectedValue != "1" && txt_salesOrder.Value == "")
            {
                ppv.Crud("update PPV set first_approval = NULL, last_approval = NULL, wo = '" + txt_WO.Value + "', po = '" + txt_PO.Value + "', qty = '" + txt_qty.Value + "', av_price = '" + txt_AvPrice.Value + "', new_price = '" + txt_NewPrice.Value + "', OtherChange = '" + cbl_changed.SelectedValue + "', elaborate = '" + txt_Eraborate.Value + "', leadtime = '" + txt_LeadTime.Value + "', id_mfg = '" + ddl_Mfg.SelectedValue + "', explanation = '" + txt_Explanation.Value + "', pn = '" + ddl_pn.SelectedValue + "', client = '" + ddl_client.SelectedValue + "', vendor = '" + ddl_vendor.SelectedValue + "', salesOrder = '" + rb_salesOrder.SelectedValue + "', salesOrder_num = '" + txt_salesOrder.Value + "' where id_ppv = '" + ppv.Id_ppv + "'");
            }
            else
            {
                ppv.Crud("update PPV set wo = '" + txt_WO.Value + "', po = '" + txt_PO.Value + "', qty = '" + txt_qty.Value + "', av_price = '" + txt_AvPrice.Value + "', new_price = '" + txt_NewPrice.Value + "', OtherChange = '" + cbl_changed.SelectedValue + "', elaborate = '" + txt_Eraborate.Value + "', leadtime = '" + txt_LeadTime.Value + "', id_mfg = '" + ddl_Mfg.SelectedValue + "', explanation = '" + txt_Explanation.Value + "', pn = '" + ddl_pn.SelectedValue + "', client = '" + ddl_client.SelectedValue + "', vendor = '" + ddl_vendor.SelectedValue + "', salesOrder = '" + rb_salesOrder.SelectedValue + "', salesOrder_num = '" + txt_salesOrder.Value + "' where id_ppv = '" + ppv.Id_ppv + "'");
        ...
        {
            ppv.Crud("update PPV set void = '1', wo = '" + txt_WO.Value + "', po = '" + txt_PO.Value + "', qty = '" + txt_qty.Value + "', av_price = '" + txt_AvPrice.Value + "', new_price = '" + txt_NewPrice.Value + "', OtherChange = '" + cbl_changed.SelectedValue + "', elaborate = '" + txt_Eraborate.Value + "', leadtime = '" + txt_LeadTime.Value + "', id_mfg = '" + ddl_Mfg.SelectedValue + "', explanation = '" + txt_Explanation.Value + "', pn = '" + ddl_pn.SelectedValue + "', client = '" + ddl_client.SelectedValue + "', vendor = '" + ddl_vendor.SelectedValue + "', salesOrder = '" + rb_salesOrder.SelectedValue + "', salesOrder_num = '" + txt_salesOrder.Value + "' where id_ppv = '" + ppv.Id_ppv + "'");
            Response.Redirect("MainMenu.aspx");
        }
